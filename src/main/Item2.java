...
public class Item2 {
     ...
     */
    public Item2(Stage primaryStage, Player player) {
    ...
    public void handleUseBtn(Item item, Player player) {
    ...
    public GridPane loadItem1() {
        ...
        //USe button
        VBox vBoxUse = new VBox();
        vBoxUse.getChildren().add(this.useBtn);
        gridPane.add(vBoxUse, 0, 3, 2, 1);

        // Close button
        VBox vBoxClose = new VBox();
        vBoxClose.getChildren().add(this.btnClose);
        gridPane.add(vBoxClose, 0, 3, 2, 1);
